...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Udacity Project Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerOf(_tokenId1) == msg.sender) || (ownerOf(_tokenId2) == msg.sender), "You can't exchange Stars unless you own one of them.");
